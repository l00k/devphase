...
import type { ContractExecResult, ContractInstantiateResult } from "@polkadot/types/interfaces/contracts";
...
export namespace Flipper {
    ...
    namespace ContractQuery {
        export interface New extends DPT.ContractQuery {
            (
                origin: DPT.ContractCallOrigin,
                options: DPT.ContractCallOptions,
                init_value: boolean | PT.Bool,
            ): DPT.CallReturn<
                ContractInstantiateResult
            >;
        }

        export interface Default extends DPT.ContractQuery {
            (
                origin: DPT.ContractCallOrigin,
                options: DPT.ContractCallOptions,
            ): DPT.CallReturn<
    ...
    interface MapMessageQuery extends DPT.MapMessageQuery {
        new: ContractQuery.New;
        default: ContractQuery.Default;
